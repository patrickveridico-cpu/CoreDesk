...
export function GlobalTopBar() {
  ...
  return <aside data-testid="coredesk-topbar" data-debug="coredesk-topbar" className="relative z-[100] flex h-12 shrink-0 items-center gap-2 border-b border-core-line bg-core-panel px-2 text-slate-100" onClick={() => menuProfileId && setMenuProfileId(undefined)}>
